...
class SystemController {
	public:
		SystemController();
		enum class SYSTEM_STATE {CONNECTING_TO_GPS, CONNECTING_TO_NETWORK, CONNECTED_TO_NETWORK, CONNECTING_TO_DATA_SERVER, CONNECTED_TO_DATA_SERVER, NORMAL_OPERATION};
		void setup();
		void loop();
	private:
		UI* ui;
