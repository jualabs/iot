#ifndef __SYSTEM_PARAMS_H__
#define __SYSTEM_PARAMS_H__

const unsigned int automaticIrrigationStartHour = 7;
const unsigned int automaticIrrigationStartMin = 30;
const float efc = 0.9;
const unsigned int ngp = 1;
const float vg = 1.5;
const float esp1 = 0.7;
const float esp2 = 0.4; 
const float ia = (ngp * vg) / (esp1 * esp2);

const float kc[70] = {0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.812,0.824,0.836,0.848,
